  ...
  return (
    <div class="w-full h-screen  ">
        ...
        <div className='absolute top-0 flex flex-col justify-center w-full h-full text-white'>
            ...
            <button className='px-3 py-2 text-black transition duration-100 ease-linear transform bg-white border border-white rounded-full hover:scale-110'>Reserve Now</button>
            </div>
