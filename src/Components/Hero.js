  ...
  return (
    <div class="w-full h-screen  ">
        ...
        <div className='absolute top-0 flex flex-col justify-center w-full h-full text-center text-white md:text-left p-11'>
            ...
            <button className='px-3 py-2 text-white transition duration-100 ease-linear transform rounded-full hover:scale-110 hover:bg-blue-600 bg-sky-400'>Reserve Now</button>
            </div>
