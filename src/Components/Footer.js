...
const Footer = () => {
  return (
    <div className='w-full px-2 py-2 mt-24 text-gray-300 bg-gray-900'>
      <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4'>
        <div>
          <h6 className='pt-2 font-bold uppercare'>Solutions</h6>
          <ul>
        ...
        <div>
          <h6 className='pt-2 font-bold uppercare'>Support</h6>
          <ul>
        ...
        <div>
          <h6 className='pt-2 font-bold uppercare'>Company</h6>
          <ul>
        ...
        <div>
          <h6 className='pt-2 font-bold uppercare'>Legal</h6>
          <ul>
